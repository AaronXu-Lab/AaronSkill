...
| [`aw-design-system-gallery`](./aw-design-system-gallery/) | `3.12.0` | 审查或优化 Gallery 的组件展示、属性轴、默认示例与比较结构 | Caption 仅含真实公开轴；边界不明显且有范围审阅价值时，提示须保持 Gallery-only；通用分类保持领域中立，项目配置留在目标仓库 |
