...
- Last successful refresh: `2026-09-20T15:30:21+00:00`
- Discovery leads: `40`
- Evidence: index metadata only; verify exact source, behavior, dependencies and license.

| Component | Description | Preview | Source |
|---|---|---|---|
| Action Bar |  | [Preview](https://diceui.com/docs/components/base/action-bar) | [Source](https://diceui.com/r/base-vega/action-bar.json) |
| Angle Slider |  | [Preview](https://diceui.com/docs/components/base/angle-slider) | [Source](https://diceui.com/r/base-vega/angle-slider.json) |
| Avatar Group |  | [Preview](https://diceui.com/docs/components/base/avatar-group) | [Source](https://diceui.com/r/base-vega/avatar-group.json) |
| Badge Overflow |  | [Preview](https://diceui.com/docs/components/base/badge-overflow) | [Source](https://diceui.com/r/base-vega/badge-overflow.json) |
| Banner |  | [Preview](https://diceui.com/docs/components/base/banner) | [Source](https://diceui.com/r/base-vega/banner.json) |
| Circular Progress |  | [Preview](https://diceui.com/docs/components/base/circular-progress) | [Source](https://diceui.com/r/base-vega/circular-progress.json) |
| Color Picker |  | [Preview](https://diceui.com/docs/components/base/color-picker) | [Source](https://diceui.com/r/base-vega/color-picker.json) |
| Color Swatch |  | [Preview](https://diceui.com/docs/components/base/color-swatch) | [Source](https://diceui.com/r/base-vega/color-swatch.json) |
| Compare Slider |  | [Preview](https://diceui.com/docs/components/base/compare-slider) | [Source](https://diceui.com/r/base-vega/compare-slider.json) |
| Cropper |  | [Preview](https://diceui.com/docs/components/base/cropper) | [Source](https://diceui.com/r/base-vega/cropper.json) |
| Editable |  | [Preview](https://diceui.com/docs/components/base/editable) | [Source](https://diceui.com/r/base-vega/editable.json) |
...
| Responsive Dialog |  | [Preview](https://diceui.com/docs/components/base/responsive-dialog) | [Source](https://diceui.com/r/base-vega/responsive-dialog.json) |
| Scroll Spy |  | [Preview](https://diceui.com/docs/components/base/scroll-spy) | [Source](https://diceui.com/r/base-vega/scroll-spy.json) |
...
| Status |  | [Preview](https://diceui.com/docs/components/base/status) | [Source](https://diceui.com/r/base-vega/status.json) |
| Stepper |  | [Preview](https://diceui.com/docs/components/base/stepper) | [Source](https://diceui.com/r/base-vega/stepper.json) |
| Swap |  | [Preview](https://diceui.com/docs/components/base/swap) | [Source](https://diceui.com/r/base-vega/swap.json) |
| Time Picker |  | [Preview](https://diceui.com/docs/components/base/time-picker) | [Source](https://diceui.com/r/base-vega/time-picker.json) |
| Timeline |  | [Preview](https://diceui.com/docs/components/base/timeline) | [Source](https://diceui.com/r/base-vega/timeline.json) |
| Tour |  | [Preview](https://diceui.com/docs/components/base/tour) | [Source](https://diceui.com/r/base-vega/tour.json) |
